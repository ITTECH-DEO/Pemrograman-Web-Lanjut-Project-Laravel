...
<body>
	...
	<div class="full">
			<div class="menu">
				<ul>
					<li><a href="/movies"><div class="hm"><i class="home1"></i><i class="home2"></i></div></a></li>
		...
		<div class="review-content">
			<div class="top-header span_top">
				<div class="logo">
					<a href="reviews.html"><img src="vendor/images/logo.png" alt="" /></a>
					<p>Movie Theater</p>
				</div>
			...
			<div class="reviews-section">
				<h3 class="head">Movie Reviews</h3>
					<div class="col-md-9 reviews-grids">
						<div class="review">
							<div class="movie-pic">
								<a href="single.html"><img src="vendor/images/r4.jpg" alt="" /></a>
							</div>
							<div class="review-info">
								<a class="span" href="single.html">Instellar  <i>Movie Review</i></a>
						...
						<div class="review">
							<div class="movie-pic">
								<a href="single.html"><img src="vendor/images/r6.jpg" alt="" /></a>
							</div>
							<div class="review-info">
								<a class="span" href="single.html">Big Hero 6  <i>Movie Review</i></a>
								<p class="dirctr"><a href="">Reagan Gavin Rasquinha, </a>TNN, Mar 12, 2015, 12.47PM IST</p>
								<p class="ratingview">Critic's Rating:</p>
								<div class="rating">
									<span>☆</span>
						...
						<div class="review">
							<div class="movie-pic">
								<a href="single.html"><img src="vendor/images/r5.jpg" alt="" /></a>
							</div>
							<div class="review-info">
								<a class="span" href="single.html">Dawn Planet Apes  <i>Movie Review</i></a>
								<p class="dirctr"><a href="">Reagan Gavin Rasquinha, </a>TNN, Mar 12, 2015, 12.47PM IST</p>
								<p class="ratingview">Critic's Rating:</p>
								<div class="rating">
									<span>☆</span>
						...
						<div class="review">
							<div class="movie-pic">
								<a href="single.html"><img src="vendor/images/r1.jpg" alt="" /></a>
							</div>
							<div class="review-info">
								<a class="span" href="single.html">The Lego Movie  <i>Movie Review</i></a>
								<p class="dirctr"><a href="">Reagan Gavin Rasquinha, </a>TNN, Mar 12, 2015, 12.47PM IST</p>
								<p class="ratingview">Critic's Rating:</p>
								<div class="rating">
									<span>☆</span>
						...
						<div class="review">
							<div class="movie-pic">
								<a href="single.html"><img src="vendor/images/r3.jpg" alt="" /></a>
							</div>
							<div class="review-info">
								<a class="span" href="single.html">Avangers <i>Movie Review</i></a>
								<p class="dirctr"><a href="">Reagan Gavin Rasquinha, </a>TNN, Mar 12, 2015, 12.47PM IST</p>
								<p class="ratingview">Critic's Rating:</p>
								<div class="rating">
									<span>☆</span>
					...
					<div class="col-md-3 side-bar">
						<div class="featured">
							...
							<ul>
								<li>
									<a href="single.html"><img src="vendor/images/f1.jpg" alt="" /></a>
									<p>lorem movie review</p>
								</li>
								<li>
									<a href="single.html"><img src="vendor/images/f2.jpg" alt="" /></a>
									<p>lorem movie review</p>
								</li>
								<li>
									<a href="single.html"><img src="vendor/images/f3.jpg" alt="" /></a>
									<p>lorem movie review</p>
								</li>
								<li>
								...
								<li>
									<a href="single.html"><img src="vendor/images/f5.jpg" alt="" /></a>
									<p>lorem movie review</p>
								</li>
								<li>
									<a href="single.html"><img src="vendor/images/f6.jpg" alt="" /></a>
									<p>lorem movie review</p>
								</li>
								<div class="clearfix"></div>
							</ul>
						...
						<div class="entertainment">
							...
							<ul>
								<li class="ent">
									<a href="single.html"><img src="vendor/images/f4.jpg" alt="" /></a>
								</li>
								<li>
									<a href="single.html">Watch ‘Bombay Velvet’ trailer during WC match</a>
				...
				<div class="might-grid">
					<div class="grid-might">
						<a href="single.html"><img src="vendor/images/mi.jpg" class="img-responsive" alt=""> </a>
					</div>
					<div class="might-top">
				...
				<div class="might-grid">
					<div class="grid-might">
						<a href="single.html"><img src="vendor/images/mi1.jpg" class="img-responsive" alt=""> </a>
					</div>
					<div class="might-top">
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p> 
						<a href="single.html">Lorem Ipsum <i> </i></a>
				...
				<div class="might-grid">
					<div class="grid-might">
						<a href="single.html"><img src="vendor/images/mi2.jpg" class="img-responsive" alt=""> </a>
					</div>
					<div class="might-top">
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p> 
						<a href="single.html">Lorem Ipsum <i> </i></a>
				...
				<div class="might-grid">
					<div class="grid-might">
						<a href="single.html"><img src="vendor/images/mi3.jpg" class="img-responsive" alt=""> </a>
					</div>
					<div class="might-top">
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p> 
						<a href="single.html">Lorem Ipsum <i> </i></a>
